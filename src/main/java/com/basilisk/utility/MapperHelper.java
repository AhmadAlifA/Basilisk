package com.basilisk.utility;

import com.basilisk.dto.ValidationDTO;
...
//    }
    ...
    public static List<ValidationDTO> getErrors(List<ObjectError> errors){
        ...
        for(var error : errors){
            ...
            dto.add(new ValidationDTO(fieldName, error.getDefaultMessage()));
        }
        return dto;
    }
}
